...
function spawnPigs() {
    ...
    pigs[2] = new Pig(width * .69 + 95, height*.8, 25)
}
...
function spawnBoxes() {
    ...
    boxes[3] = new Box(0.75*width, .85*height, 400, 25);
    // boxes[4] = new Box(0.71*width, .8*height, 202, 25);

    boxes[4] = new Box(0.70*width, .80*height, 15, 95);
    boxes[5] = new Box(0.80*width, .80*height, 15, 95);
    boxes[6] = new Box(0.75*width, .70*height, 200, 25);
}